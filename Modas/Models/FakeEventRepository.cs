...
namespace Modas.Models
{
    public class FakeEventRepository : IEventRepository
    {
        public IQueryable<Location> Locations => new List<Location>
        {
            ...
            //new Location { LocationId = 4, Name = "School" }
        ...
        public IQueryable<Event> Events => new List<Event>
        {
            ...
            //new Event { TimeStamp = new DateTime(2018, 4, 28, 6, 7, 4), Flagged = false, Location = Locations.FirstOrDefault(l => l.LocationId == 4) }
